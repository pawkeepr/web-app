...
export const getAllScheduledSuccess = createAction<Data[]>(ACTION_GET_ALL_SCHEDULED)
...
export const getAllScheduledCanceledSuccess = createAction<Data[]>(ACTION_GET_ALL_SCHEDULED_CANCELED)
...
export const getAllScheduledConfirmedSuccess = createAction<Data[]>(ACTION_GET_ALL_SCHEDULED_CONFIRMED)
...
export const getAllScheduledConfirmedDoneSuccess = createAction<Data[]>(ACTION_GET_ALL_SCHEDULED_CONFIRMED_DONE)
