...
export const getVeterinaryAppointment = () =>
    api.get(url.GET_VETERINARY_APPOINTMENTS);
...
// Pages > Team
export const getTeamData = (team: AxiosRequestConfig<any> | undefined) =>
    api.get(url.GET_TEAMDATA, team);
...
// Folder
export const getFolders = (folder: AxiosRequestConfig<any> | undefined) =>
    api.get(url.GET_FOLDERS, folder);
...
// File
export const getFiles = (file: AxiosRequestConfig<any> | undefined) =>
    api.get(url.GET_FILES, file);
...
// To Do
export const getTodos = (todo: AxiosRequestConfig<any> | undefined) =>
    api.get(url.GET_TODOS, todo);
...
// To do Project
export const getProjects = (project: AxiosRequestConfig<any> | undefined) =>
    api.get(url.GET_PROJECTS, project);
