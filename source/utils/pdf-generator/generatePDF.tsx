...
const mockAppointment = {
    ...
    treatment: {
        ...
        'Aplicar Medicamentos': [
            {
                Medicamento:
                    'Gaviz 10mg 1/4 do comprimido, de 12 em 12 horas, por 15 dias',
            },
            {
                Medicamento:
                    'glutamina 4 gotas via oral, de 8 em 8 horas, por 30 dias',
            },
        ],
        'Aplicar Vacinas': [
            {
        ...
        <Document>
                ...
                <div className="flex">
                    <View style={styles.flex}>
                        <View style={styles.sectionRight}>
                            ...
                            <Text style={styles.info}>
                                Nome: {mockAppointment.vet_data.name}
                            </Text>
                            <Text style={styles.info}>
                                Telefone: {mockAppointment.vet_data.phone}
                            </Text>
                            <Text style={styles.info}>
                                Email: {mockAppointment.vet_data.email}
                            </Text>
                        </View>
                    ...
                    <View style={styles.sectionRight}>
                        ...
                        <Text style={styles.flex}>
                            Nome..........................................
                            {mockAppointment.pet_data.name_pet}
                        </Text>
                        <Text style={styles.flex}>
                            Espécie........................................
                            {mockAppointment.pet_data.specie}
                        </Text>
                        <Text style={styles.flex}>
                            Raça.................................................
                            {mockAppointment.pet_data.race}
                        </Text>
                        <Text style={styles.flex}>
                            Sexo................................................
                            {mockAppointment.pet_data.sex}
                        </Text>
                        <Text style={styles.flex}>
                            Idade...............................................
                            {mockAppointment.pet_data.date_birth}
                        </Text>
                    </View>
                    ...
                    <View style={styles.sectionRight}>
                        ...
                        <Text style={styles.flex}>
                            Nome.................................
                            {mockAppointment.tutor_data.name}
                        </Text>
                        <Text style={styles.flex}>
                            Email................................
                            {mockAppointment.tutor_data.email}
                        </Text>
                        <Text style={styles.flex}>
                            Telefone.............................
                            {mockAppointment.tutor_data.phone}
                        </Text>
                    </View>
                    <div className="flex">
                        <View style={styles.sectionCenter}>
                        ...
                        <View>
                            {Object.keys(mockAppointment?.anamnesis).map(
                                (system, index) => (
                                    <View key={index}>
                                        {mockAppointment?.anamnesis[system].map(
                                            (
                                                questions: mockAppointment,
                                                idx: mockAppointment,
                                            ) => (
                                                <View key={idx}>
                                                    {Object.entries(
            ...
            <Page size="A4" style={styles.page}>
                <div className="flex">
                    ...
                    <View>
                        {Object.keys(mockAppointment?.treatment).map(
                            (treatmentType, index) => (
                                <View key={index}>
                                    <Text style={styles.h2}>
                                        {treatmentType}
                                    </Text>
                                    {mockAppointment?.treatment[
                                        treatmentType
                                    ].map(
                                        (
                                            treatment: mockAppointment,
                                            idx: mockAppointment,
                                        ) => (
                                            <View key={idx}>
                                                {Object.entries(treatment).map(
                                                    (
                                                        [treatment, answer],
                                                        i,
                                                    ) => (
