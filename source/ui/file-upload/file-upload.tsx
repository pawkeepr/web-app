    ...
    return (
        <div className="w-full" {...getRootProps()}>
            <motion.div
                onClick={handleClick}
                whileHover="animate"
                className="relative block w-full overflow-hidden rounded-lg cursor-pointer group/file"
            >
                <input
                    ref={fileInputRef}
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="relative z-20 mt-2 font-sans text-base font-normal mobile:hidden text-neutral-400 dark:text-neutral-400">
