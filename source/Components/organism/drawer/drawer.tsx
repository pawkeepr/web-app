...
export type ModeDrawerItems =
    (typeof ModeDrawerItems)[keyof typeof ModeDrawerItems];
            ...
            {visibleDrawer && (
                <Slide left>
                    <Drawer
                        ...
                        onClose={closeDrawer}
                        direction="left"
                        className="drawer fixed h-full"
                    >
                        <div
                            className={cn(
                                `fixed !transition-all !duration-500 !ease-out flex flex-col
                            h-full py-8 border-gray-200 dark:border-dark-600 w-72
                        ...
                        >
                            <div className="flex justify-between px-4">
                                ...
                                <XMarkIcon className="w-8 h-8 cursor-pointer hover:text-gray-500 dark:hover:text-gray-400" />
                            </div>

                            <div className="flex flex-col w-full  items-center mt-6 -mx-2">
