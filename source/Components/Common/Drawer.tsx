...
const Drawer = ({ closeDrawer, display }: DrawerProps) => {
    return (
        <>
            <Slide left>
                <div
                    className={`absolute top-0 bottom-0 left-0 z-[20] flex flex-col w-64 h-screen px-4 py-8 ${display} overflow-y-auto bg-white dark:!bg-dark-500 border-r rtl:border-r-0 rtl:border-l`}
                >
