            ...
            <Dropdown isOpen={isCartDropdown} toggle={toggleCartDropdown} className="topbar-head-dropdown ms-1 header-item">
                ...
                <DropdownMenu className="dropdown-menu-xl dropdown-menu-end p-0"
                    ...
                    <SimpleBar style={{ maxHeight: "300px" }}>
                        <div className="p-2">
                            <div className="text-center empty-cart" id="empty-cart" style={{ display: "none" }}>
                                ...
                                <Link href="/apps-ecommerce-products" className="btn btn-success w-md mb-3">Shop Now</Link>
                            </div>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-1">
                                        <h6 className="mt-0 mb-1 fs-14">
                                            <Link href="/apps-ecommerce-product-details" className="text-reset">{item.product}</Link>
                                        </h6>
                    ...
                    <div className="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border d-grid" id="checkout-elem">
                        ...
                        <Link href="/apps-ecommerce-checkout" className="btn btn-success text-center w-100">
                            Checkout
                        </Link>
                    </div>
                </DropdownMenu>
