...
const CardTutors = () => {
    return (
        <Card className="team-box px-4 shadow-sm h-24 justify-center">
                    ...
                    <Row className="align-items-center">
                        ...
                        <UncontrolledDropdown className="col text-end">
                            ...
                            <DropdownMenu className="dropdown-menu-end">
                                ...
                                <li><DropdownItem><i className="ri-star-fill text-muted me-2 align-bottom"></i>Favorite</DropdownItem></li>
