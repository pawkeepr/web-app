...
export const APPOINTMENT_GET_BY_ID = () =>
    "/api-appointment/search-appointment";
...
export const PET_CREATE_SIMPLIFIED_PROFILE = () =>
    "/api-pet/create-pet-simplified";
...
// Pets and vets in Tutors

export const PET_FETCH_ALL_TUTORS = () => "/api-pet/fetch-all-pets-tutor";
export const VET_FETCH_ALL_TUTORS = () =>
    "api-pet/fetch-all-veterinary-pet-tutor";
