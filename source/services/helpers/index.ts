...
export const getVetProfile = async (app = api) =>
    app.get(urls.VET_GET_PROFILE());

export const getAllAppointmentsVet = async () =>
    api.get(urls.APPOINTMENT_GET_ALL());
...
export const finishedAppointmentVet = async (
...
export const getAllPetsOfClinic = async () =>
    api.get(urls.PET_FETCH_ALL_CLINIC());
...
export const getAppointmentExternalByID: FnAxiosAppointmentByIdExternal =
    async (id_appointment: string) =>
        api.get(urls.APPOINTMENT_GET_BY_ID_EXTERNAL(), {
            params: { id_appointment },
        });

export const confirmedAppointmentExternal: FnAxiosAppointmentByIdExternal =
    async (id_appointment: string) =>
        api.post(urls.APPOINTMENT_CONFIRMED_EXTERNAL(), {
            params: { id_appointment },
        });

export const canceledAppointmentExternal: FnAxiosAppointmentByIdExternal =
    async (id_appointment: string) =>
        api.post(urls.APPOINTMENT_CANCELED_EXTERNAL(), {
            params: { id_appointment },
        });
