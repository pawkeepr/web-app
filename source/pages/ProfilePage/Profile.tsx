                            ...
                            <TabContent activeTab={activeTab}>
                                ...
                                <TabPane tabId="4">
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            ...
                                            <li className="d-flex mt-2">
                                                <div className="flex-grow-1">
                                                    ...
                                                    <p className="text-muted">
                                                        ...
                                                        Notifications. Under Select
                                                        an account, choose the
                                                        account to enable
                                                        notifications for.{' '}
                                                    </p>
                                                </div>
                                            ...
                                            <li className="d-flex mt-2">
                                                <div className="flex-grow-1">
                                                    ...
                                                    <p className="text-muted">
                                                        Get real-time purchase
                                                        alerts to protect yourself
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted">
                                            Go to the Data & Privacy section of your
                                            profile Account. Scroll to "Your data &
                                            privacy options." Delete your Profile
                                            Account. Follow the instructions to
                                            delete your account :
                                        </p>
                                        <div>
                                            <Input
