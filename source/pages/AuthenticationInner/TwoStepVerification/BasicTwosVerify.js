                            ...
                            <Row className="justify-content-center">
                                <Col md={8} lg={6} xl={5}>
                                        ...
                                        <CardBody className="p-4">
                                            ...
                                            <div className="p-2 mt-4">
                                                <div className="text-muted text-center mb-4 mx-lg-3">
                                                    ...
                                                    <p>Please enter the 4 digit code sent to <span className="fw-bold">example@abc.com</span></p>
                                                </div>
                                    ...
                                    <div className="mt-4 text-center">
                                        <p className="mb-0">Didn't receive a code ? <Link to="/auth-pass-reset-basic" className="fw-bold text-primary text-decoration-underline">Resend</Link> </p>
                                    </div>
                                </Col>
                            </Row>
                        </Container>
