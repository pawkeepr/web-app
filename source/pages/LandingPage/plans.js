            ...
            <section className="section bg-light" id="plans">
                ...
                <Container>
                        ...
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    <div>
                                        <h5 className="fs-14 mb-0">Mês</h5>
                                    </div>
                                    ...
                                    <div>
                                        <h5 className="fs-14 mb-0">Ano<span className="badge badge-soft-success">Save 20%</span></h5>
                                    </div>
                                </div>
                            </div>
                        </Col>
                    ...
                    <Row className="gy-4">
                        ...
                        <Col lg={4}>
                            <Card className="plan-box mb-0 ribbon-box right bg-primary !text-white">
                                <CardBody className="p-4 m-2 h-42">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            <Link href="#" className="btn btn-secondary w-100">Adquirir Agora</Link>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
                    ...
                    <div className="d-flex mt-4">
                        <div className="flex-grow-1 text-center italic">
