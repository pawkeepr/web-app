                                ...
                                <Card className="explore-box card-animate border">
                                    <CardBody>
                                        <div className="d-flex align-items-center mb-3">
                                            <Image src={item.cardImg} alt="" className="avatar-xs rounded-circle" />
                                        ...
                                        <div className="explore-place-bid-img overflow-hidden rounded">
                                            <Image src={item.img} alt="" className="explore-img w-100" />
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-16 mb-0"><Link href="/apps-nft-item-details" className="link-dark">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
