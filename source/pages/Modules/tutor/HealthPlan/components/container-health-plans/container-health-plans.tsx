...
const ContainerHealthPlans = ({ id_pet }: ContainerHealthPlansProps) => {
    ...
    const { data, isLoading, isError } = useHealthPlans({ id_pet })

    return (
        <>
            <button
                type="button"
                onClick={() => console.log('Plano de saúde adicionado!')}
            ...
            >
                ...
                <div className="ml-4 text-left">
                    ...
                    <p className="text-gray-600">
                        Clique para adicionar um novo plano de saúde ao seu Pet.
                    </p>
                </div>
            </button>
