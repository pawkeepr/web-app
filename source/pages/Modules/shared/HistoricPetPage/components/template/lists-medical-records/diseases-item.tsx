...
type DiseaseItemProps = ItemProps<Disease>

const DiseaseItem = ({ item, document, id_pet }: DiseaseItemProps) => {
    ...
    const { mutateAsync } = useDeleteMedicalRecords({
        ...
        cpf_cnpj: document,
        id_pet,
        name: MEDICAL_RECORDS.DISEASES, // Ajuste conforme o enum
    })
