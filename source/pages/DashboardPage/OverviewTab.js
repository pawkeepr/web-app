                                            ...
                                            <div className="border rounded border-dashed p-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 overflow-hidden">
                                                        <h5 className="fs-15 mb-1"><Link href="#" className="text-body text-truncate d-block">App pages.zip</Link></h5>
                                                        <div>2.2MB</div>
                                                    </div>
                                        ...
                                        <Col xxl={4} lg={6}>
                                            <div className="border rounded border-dashed p-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 overflow-hidden">
                                                        <h5 className="fs-15 mb-1"><Link href="#" className="text-body text-truncate d-block">Velzon admin.ppt</Link></h5>
                                                        <div>2.4MB</div>
                                                    </div>
                                                    <div className="flex-shrink-0 ms-2">
                                                        <div className="d-flex gap-1">
                        ...
                        <CardBody>
                            ...
                            <SimpleBar style={{ height: "300px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    <div className="flex-shrink-0">
                                        <Image src={avatar8} alt="" className="avatar-xs rounded-circle" />
                                    </div>
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <div className="d-flex mt-4">
                                            <div className="flex-shrink-0">
                                                <Image src={avatar10} alt="" className="avatar-xs rounded-circle" />
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <Row className="g-2 mb-3">
                                            <div className="col-lg-1 col-sm-2 col-6">
                                                <Image src={image4} alt="" className="img-fluid rounded" />
                                            </div>
                                            <div className="col-lg-1 col-sm-2 col-6">
                                                <Image src={image5} alt="" className="img-fluid rounded" />
                                            </div>
                                        </Row>
                                        <Link href="#" className="badge text-muted bg-light"><i className="mdi mdi-reply"></i> Reply</Link>
                                        <div className="d-flex mt-4">
                                ...
                                <div className="vstack gap-3">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Nancy Martino</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Henry Baird</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm">Message</button>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Frank Hook</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm">Message</button>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Jennifer Carter</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm">Message</button>
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <Image src={avatar7} alt="" className="img-fluid rounded-circle" />
                                        </div>
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Joseph Parker</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm">Message</button>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5 className="fs-14 mb-0"><Link href="#" className="text-body d-block">Alexis Clarke</Link></h5>
                                        </div>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex align-items-center gap-1">
                                                <button type="button" className="btn btn-light btn-sm">Message</button>
                            ...
                            <div className="vstack gap-2">
                                ...
                                <div className="border rounded border-dashed p-2">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-15 mb-1"><Link href="#" className="text-body text-truncate d-block">Images.zip</Link></h5>
                                            <div>1.2MB</div>
                                        </div>
                                        <div className="flex-shrink-0 ms-2">
                                            <div className="d-flex gap-1">
                                ...
                                <div className="border rounded border-dashed p-2">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-14 mb-1"><Link href="#" className="text-body text-truncate d-block">bg-pattern.png</Link></h5>
                                            <div>1.1MB</div>
                                        </div>
                                        <div className="flex-shrink-0 ms-2">
                                            <div className="d-flex gap-1">
