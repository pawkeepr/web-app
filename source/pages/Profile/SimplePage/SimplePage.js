                                ...
                                <div className="p-2">
                                    ...
                                    <div className="hstack text-white-50 gap-1">
                                        <div className="me-2"><i
                                            ...
                                            United States</div>
                                        <div><i
                                            className="ri-building-line me-1 text-white-75 fs-16 align-bottom"></i>Themesbrand
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                                                                            ...
                                                                                            <div className="d-flex">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <h6
                                                                                                        ...
                                                                                                        New ticket
                                                                                                        created <span
                                                                                                            className="badge badge-soft-info align-middle">Inprogress</span>
                                                                                                    </h6>
                                                                                                    <small
                                                                                                        className="text-muted mb-2">User
                                                                                                        <span
                                                            ...
                                                            <Card className={`profile-project-card shadow-none profile-project-${item.cardBorderColor}`}>
                                                                <CardBody className="p-4">
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-shrink-0 ms-2">
                                                                            <div className={`badge badge-soft-${item.badgeClass} fs-12`}>
                                                                                {item.badgeText}</div>
                                                                        </div>
                                                                    </div>
